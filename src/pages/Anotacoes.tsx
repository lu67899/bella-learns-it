    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="relative">
          ...
          <Input placeholder="Buscar anotações..." className="pl-9" value={busca} onChange={(e) => setBusca(e.target.value)} autoComplete="one-time-code" data-1p-ignore data-lpignore="true" data-form-type="other" />
        </div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <Input placeholder="Título" value={form.titulo} onChange={(e) => setForm({ ...form, titulo: e.target.value })} autoComplete="one-time-code" data-1p-ignore data-lpignore="true" data-form-type="other" />
            <Input placeholder="Matéria (opcional)" value={form.materia} onChange={(e) => setForm({ ...form, materia: e.target.value })} autoComplete="one-time-code" data-1p-ignore data-lpignore="true" data-form-type="other" />
            <Textarea placeholder="Conteúdo" rows={6} value={form.conteudo} onChange={(e) => setForm({ ...form, conteudo: e.target.value })} autoComplete="one-time-code" />
            <Input placeholder="Tags (separadas por vírgula)" value={form.tags} onChange={(e) => setForm({ ...form, tags: e.target.value })} autoComplete="one-time-code" data-1p-ignore data-lpignore="true" data-form-type="other" />
